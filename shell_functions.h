...
/**
 * struct passinfo - this contains arguments to pass into a function,
 * to allow uniform prototype for the function pointer struct
 ...
 * @env_changed: this is for if environ was changed
 * @status: this is the return status of the last command ran
 * @cmd_buf: this is the address of pointer to cmd_buf
...
int interact(info_t *);
int is_a_delimeter(char, char *);
int is_an_alpha(int);
int _shell_convert(char *);

int _errshell_convert(char *);
