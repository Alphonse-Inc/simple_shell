...
/**
 * shell_env - this prints the current environment
...
/**
 * _mysetenv - Initialize a new environment variable or modify old one
 * @info: Structure containing potential arguments
 * Return: Always 0
 */
int _mysetenv(info_t *info)
{
	if (info->argc != 3)
	{
		_eputs("This is an incorrect number of arguements\n");
		return (1);
	}
